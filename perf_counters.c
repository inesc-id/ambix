...
static struct counter_t COUNTERs[] = {
    {.event = 0xe3, .mult = 64, .fact = 1024*1024, .name = "PMM_READ", .unit = "Mb"},
    {.event = 0xe7, .mult = 64, .fact = 1024*1024, .name = "PMM_WRITE", .unit = "Mb"},

    {.event = 0x304, .mult = 64, .fact = 1024*1024, .name = "DDR_READ", .unit = "Mb"},
    {.event = 0xc04, .mult = 64, .fact = 1024*1024, .name = "DDR_WRITE", .unit = "Mb"},
};
